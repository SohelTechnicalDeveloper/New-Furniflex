...
import profileImage from '../image/SohelImage.png'
import {
  MDBCol,
  MDBContainer,
  MDBRow,
...
export default function ProfilePage() {
  ...
  return (
    <section style={{ backgroundColor: '#fff',marginTop:"4rem" }}>
         ...
         <MDBCol lg="4">
            <MDBCard className="mb-4">
              <MDBCardBody className="text-center">
                ...
                <p className="text-muted mb-4">{item.address}</p>
            ...
            <MDBCard className="mb-4">
              <MDBCardBody>
                ...
                <MDBRow>
                  ...
                  <MDBCol sm="9">
                    <MDBCardText className="text-muted">{item.mobileNo}</MDBCardText>
                  </MDBCol>
                </MDBRow>
                <hr />
                <MDBRow>
